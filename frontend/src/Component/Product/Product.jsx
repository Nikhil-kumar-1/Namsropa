        ...
        >
          ...
          <div className="p-3 sm:p-4 bg-white">
            ...
            <div className="flex items-center justify-between">
              ...
              <motion.button
                className="bg-black text-yellow-400 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs hover:bg-yellow-400 hover:text-black transition-all duration-300 flex items-center gap-1 font-serif"
