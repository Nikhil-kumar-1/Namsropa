          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col items-center justify-start h-full space-y-6 text-xl px-6">
                ...
                {/* Mobile Cart */}
                <motion.div className="w-full text-center border-b border-gray-200 py-4">
                  <Link to="/cart" className="relative inline-flex items-center">
                    <span>Cart</span>
                    {cartCount > 0 && (
                      <span className="absolute -top-2 -right-6 bg-yellow-500 text-black rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">
                        {cartCount}
                      </span>
                    )}
                  </Link>
